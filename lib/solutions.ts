...
export const CHALLENGE_LABELS: Record<ChallengeId, string> = {
  revenue: "Omset stagnan / turun",
  cost: "Biaya besar / boros",
  risk_trust: "Ada risiko kecurangan / data tidak aman / brand tidak dipercaya",
  cash_stock: "Kas & stok sering meleset",
  reporting: "Data & keputusan bisnis sering telat"
};
...
export const QUALITY_QUESTIONS: QualityQuestion[] = [
  {
    ...
    options: [
      { id: "revenue", label: "Omset stagnan / turun", note: "Lead ada tapi closing rendah, repeat order jarang, atau margin menipis", emoji: "📉" },
      { id: "cost", label: "Biaya besar / boros", note: "Banyak pekerjaan manual, duplikasi, atau waktu terbuang di proses berulang", emoji: "💸" },
      { id: "risk_trust", label: "Ada risiko kecurangan / data tidak aman / brand tidak dipercaya", note: "Transaksi mencurigakan, data tidak sinkron, review tidak terbaca, atau sulit ditemukan pelanggan", emoji: "🚨" },
      { id: "cash_stock", label: "Kas & stok sering meleset", note: "Prediksi kas salah, stok habis mendadak, modal tertahan, atau data tidak update", emoji: "📊" },
...
export const FRICTION_SOURCES: Record<FrictionSourceId, { label: string; note: string }> = {
  ...
  manual_reports: { label: "Gabung data / buat laporan manual", note: "Setiap periode copy-paste dan gabungkan data dari banyak sumber" },
